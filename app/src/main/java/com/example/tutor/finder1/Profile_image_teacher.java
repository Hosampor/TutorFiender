...
public class Profile_image_teacher extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_profile_image_teacher);
                                    ...
                                    reference_student_teacher.child("image").setValue(url).addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if (task.isSuccessful()){
                                                ...
                                                finish();
//                                                Intent intent=new Intent(Profile_image_teacher.this,PermisionActivity.class);
//                                                startActivity(intent);
//                                                Toast.makeText(Profile_image_teacher.this,"Complite",Toast.LENGTH_SHORT).show();
