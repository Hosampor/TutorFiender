...
public class Manage_2 extends AppCompatActivity {
    Button bt_male,bt_female,but;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manage_2);
        ...
        textView=findViewById(R.id.textView888);
        but=findViewById(R.id.but123);
        //but.setVisibility(View.VISIBLE);
        but.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(Manage_2.this,AddActivityTeacher.class);
                startActivity(intent);
                //startActivity(new Intent(Manage_2.this,AddActivity.class));
                //Manage_2.this.finish();
            }
        });
        ...
        bt_male.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String female="Male";
                Intent intent=new Intent(Manage_2.this,TutorAccountActivity.class);
